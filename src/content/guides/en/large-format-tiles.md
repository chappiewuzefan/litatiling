...
title: "Large-Format Tiles: Substrates, Lippage & Movement Joints"
description: "What Canberra homeowners should understand about large-format tile substrates, handling, set-out, adhesive coverage, lippage and movement joints."
excerpt: "Large tiles can create a calm surface with fewer joints, but they make substrate, handling and layout decisions more important."
category: "Tile installation"
heroImage: "/case-studies/selected/hero/living-room-floor.webp"
heroAlt: "Large-format grey floor tiles across a Canberra living area."
...
2. complete suitable grinding, patching, screeding or levelling where included;
3. allow the preparation system to reach the required condition;
4. install the tiles with a compatible adhesive method.
...
1. Is the product suitable for this wall, floor or external application?
2. What substrate preparation is likely?
3. Does the proposed laying pattern match product guidance?
4. How will edges, corners, wastes and transitions be finished?
5. Where are movement joints expected?
6. Can the tiles physically reach the work area?
7. Is the quantity sufficient for cuts, variation and spares?

Large format can be an excellent result when the project is designed around it. For [Canberra floor and wall tiling](/en/services/floor-and-wall-tiling-canberra), include the full product specification and photos of the route into the room with your enquiry.
